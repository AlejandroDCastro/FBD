...
-- Volcando datos para la tabla ejemplo.asignaturas: ~5 rows (aproximadamente)
...
-- Volcando datos para la tabla ejemplo.coordinadores: ~3 rows (aproximadamente)
...
-- Volcando datos para la tabla ejemplo.imparte: ~3 rows (aproximadamente)
